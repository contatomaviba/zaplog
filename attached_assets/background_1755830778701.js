...
chrome.runtime.onMessage.addListener((request, sender, sendResponse) => {
  if (request.action === "openDashboard") {
    ...
    chrome.tabs.create({
      url: "https://251967a7-690b-4d86-892e-86b12263b08f-00-2h05uegfvhscr.spock.replit.dev"
    });
...
async function handleCreateTrip(tripData) {
  try {
    ...
    const response = await fetch('https://251967a7-690b-4d86-892e-86b12263b08f-00-2h05uegfvhscr.spock.replit.dev/api/trips', {
      method: 'POST',
      headers: {
